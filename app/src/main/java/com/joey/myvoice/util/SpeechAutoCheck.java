...
public class SpeechAutoCheck {
    ...
    private static final String TAG = "SpeechAutoCheck";

    public SpeechAutoCheck(Context context, final Handler handler , boolean enableOffline) {
    ...
    public void checkAsr(final Map<String, Object> params) {
        Thread t = new Thread(new Runnable() {
            @Override
            public void run() {
                SpeechAutoCheck obj = checkAsrInternal(params);
                name = "识别";
    ...
    private SpeechAutoCheck checkAsrInternal(Map<String, Object> params) {
