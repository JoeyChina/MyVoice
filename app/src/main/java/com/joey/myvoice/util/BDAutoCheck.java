 ...
 * });
 */
public class BDAutoCheck {

    private static BDAutoCheck instance;
     ...
     * @return
     */
    public static BDAutoCheck getInstance(Context context) {
        if (instance == null || BDAutoCheck.context != context) {
            instance = new BDAutoCheck(context);
        }
        return instance;
    }
    ...
    public void check(final InitConfig initConfig, final Handler handler) {
        Thread t = new Thread(new Runnable() {
            @Override
            public void run() {
                BDAutoCheck obj = innerCheck(initConfig);
                isFinished = true;
    ...
    private BDAutoCheck innerCheck(InitConfig config) {
    ...
    private BDAutoCheck(Context context) {
